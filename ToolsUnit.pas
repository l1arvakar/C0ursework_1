...
uses
    ...
    Vcl.WinXPickers, Vcl.TabNotBk, Vcl.ExtDlgs, IOUtils;
type
    TTools = class(TObject)
        function TakeName(FileName: string): string;
...
implementation
uses
    PlaySoundUnit, AddPlaylistSongsUnit, AddPlaylistUnit, RenameTrackUnit, SettingsUnit, MiniViewUnit;

function TTools.TakeName(FileName: string): string;
var
